...
const ExerciseCard = ({ exercise }) => {
  return (
    ...
    >
    <img src={exercise.gifUrl} alt={exercise.name} loading="on-hoover"/>
        <Stack direction="row">
            <Button
        ...
        <Typography ml="21px" color="#000" fontWeight="bold" mt="11px" pb="10px" textTransform="capitalize" fontSize="22px"></Typography>
    </Link>
  )
}
